 ...
 */
final class Version20200311152939 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE under_rubric (id INT AUTO_INCREMENT NOT NULL, rubric_id INT NOT NULL, picture_id INT DEFAULT NULL, under_thematic_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, enable TINYINT(1) NOT NULL, content LONGTEXT DEFAULT NULL, show_order INT NOT NULL, show_all TINYINT(1) NOT NULL, INDEX IDX_E1884228A29EC0FC (rubric_id), INDEX IDX_E1884228EE45BDBF (picture_id), INDEX IDX_E18842285C5F2819 (under_thematic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE underrubricreader_corbeille (under_rubric_id INT NOT NULL, corbeille_id INT NOT NULL, INDEX IDX_B1BA7C217133F41C (under_rubric_id), INDEX IDX_B1BA7C2157350F79 (corbeille_id), PRIMARY KEY(under_rubric_id, corbeille_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE underrubricwriter_corbeille (under_rubric_id INT NOT NULL, corbeille_id INT NOT NULL, INDEX IDX_93DE898E7133F41C (under_rubric_id), INDEX IDX_93DE898E57350F79 (corbeille_id), PRIMARY KEY(under_rubric_id, corbeille_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE underrubricreader_corbeille ADD CONSTRAINT FK_B1BA7C217133F41C FOREIGN KEY (under_rubric_id) REFERENCES under_rubric (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE underrubricreader_corbeille ADD CONSTRAINT FK_B1BA7C2157350F79 FOREIGN KEY (corbeille_id) REFERENCES corbeille (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE underrubricwriter_corbeille ADD CONSTRAINT FK_93DE898E7133F41C FOREIGN KEY (under_rubric_id) REFERENCES under_rubric (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE underrubricwriter_corbeille ADD CONSTRAINT FK_93DE898E57350F79 FOREIGN KEY (corbeille_id) REFERENCES corbeille (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE underrubricreader_corbeille DROP FOREIGN KEY FK_B1BA7C2157350F79');
        $this->addSql('ALTER TABLE underrubricwriter_corbeille DROP FOREIGN KEY FK_93DE898E57350F79');
        ...
        $this->addSql('ALTER TABLE underrubricreader_corbeille DROP FOREIGN KEY FK_B1BA7C217133F41C');
        $this->addSql('ALTER TABLE underrubricwriter_corbeille DROP FOREIGN KEY FK_93DE898E7133F41C');
        ...
        $this->addSql('DROP TABLE underrubricreader_corbeille');
        $this->addSql('DROP TABLE underrubricwriter_corbeille');
